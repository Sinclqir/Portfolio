  ...
  return (
    ...
    <div id="Opinions" className='opinions'>
      ...
      <div className="boxes">
        ...
        <OpinionBox animation = "fade-up" heading = "Mathéo Spatola, tuteur de stage chez Viapass" text = "~ J'ai eu le plaisir de travailler avec Sinclair en tant que développeur stagiaire en mars 2022. Sinclair a montré une grande capacité à comprendre rapidement les projets qui lui ont été confiés et a été capable de travailler de manière autonome. Son attention aux détails et sa rigueur ont été des atouts majeurs dans la réussite de nos projets. Je recommande vivement Sinclair pour toute opportunité de développement web."/>
