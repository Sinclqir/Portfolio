      ...
      <div data-aos = "fade-up">
        <div className="boxes">
          <div className="carousel owl-carousel">
            ...
            <ProjectBox title = "Appolo X" description = "Technologies utilisées: JavaScript, HTML, CSS, ReactJS" author="Réalisé en groupe" time= "Temps passé: 2 mois" img= {img3} link = "https://github.com/Appolo-X/Site_web"  />
