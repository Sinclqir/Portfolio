      ...
      <div data-aos = "fade-up">
        <div className="boxes">
          <div className="carousel owl-carousel">
            ...
            <ProjectBox title = "Portfolio Website" description = "Technologies utilisées: JavaScript, HTML, CSS, ReactJS" author="Réalisé en autonomie" time= "Temps passé: 1 semaine" img= {img2} link = "https://github.com/"  />
